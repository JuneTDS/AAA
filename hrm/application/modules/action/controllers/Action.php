...
class Action extends MX_Controller
{
    ...
    public function promotion_progression_v2($promotion_pdf_info){

        $form_data = $this->input->post();
        $data = $form_data["data"];

        $today       = $promotion_pdf_info[0]; // $data[0];
        $designation = $promotion_pdf_info[1];
        $effect_date = $promotion_pdf_info[2];
        $emp_name    = $promotion_pdf_info[3];
        $firm_id     = $promotion_pdf_info[4]; // $data[4];
        ...
        $title_content = '<tr><td><p><strong>RE: <u>PROMOTION AND PROGRESSION</u></strong></p></td></tr><p>&nbsp;</p>';
        $content .= $title_content;
        ...
        return array("link" => $array_link, "filename" => "Promotion & Progression Letter - (".$emp_name.") UTS".$uts.".pdf");
    }
