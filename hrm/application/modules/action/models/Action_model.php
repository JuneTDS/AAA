...
class Action_model extends CI_Model
{
    ...
    public function get_event_info($staff_id){
        ...
        // echo "SELECT payroll_event_info.*, payroll_user_employee.user_id FROM payroll_event_info LEFT JOIN payroll_user_employee ON payroll_user_employee.employee_id = payroll_event_info.employee_id WHERE payroll_event_info.employee_id='".$staff_id."' AND payroll_event_info.deleted=0";
        if ($q->num_rows() > 0) {
