				...
				<div class="col-md-12">
					...
					<div class="form-group">
		            	<div style="width: 100%;">
		                	...
		                	<div style="width: 100%;">
								<input type="radio" class="" name="holiday_type" value="1"> For Singapore
								<input type="radio" class="" name="holiday_type" value="2" style="margin-left: 20px"> For Malaysia
								<input type="radio" class="" name="holiday_type" value="3" style="margin-left: 20px"> For Both
							</div>
		                </div>
		            </div>
					<div class="form-group">
