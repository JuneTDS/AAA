...
class Location_model extends CI_Model
{
    ...
    public function get_all_arrangement($nameClause){
        if ($nameClause != "") {
            $all_arrangement = $this->db->query(" SELECT payroll_employee.name,payroll_location_arrangement.arrangement_location,payroll_location_arrangement.arrangement_start,payroll_location_arrangement.arrangement_end,payroll_location_arrangement.is_client_office FROM payroll_location_arrangement LEFT JOIN payroll_employee ON payroll_employee.id = payroll_location_arrangement.arrangement_employee_id WHERE payroll_location_arrangement.deleted = 0 AND ".$nameClause." ORDER BY payroll_location_arrangement.arrangement_start ");
        } else {
    ...
    public function get_old_arrangement($nameClause){
        if ($nameClause != "") {
