...
class Location extends MX_Controller
{
    ...
    {   
        ...
        {
            $employeeList = $this->employee_model->get_employeeList($this->user_id);
            $nameClause = "(";
            foreach ($employeeList as $key => $value) {
                // print_r($value->name);
                if ($nameClause != "(") {
                    $nameClause .= " or payroll_employee.id = ".$value->id;
                } else {
                    $nameClause .= "payroll_employee.id = ".$value->id;
                }
                // echo "<br/><br/>";
            }
            $nameClause .= ")";
        ...
        $this->data['all_arrangement'] = $this->location_model->get_all_arrangement($nameClause);
        $this->data['new_arrangement'] = $this->location_model->get_new_arrangement($nameClause);
        $this->data['old_arrangement'] = $this->location_model->get_old_arrangement($nameClause);
