...
class Employee extends MX_Controller
{
    ...
    {   
        ...
        if($staff_id != null){
            ...
            $this->data['admin_access'] = $this->auth_model->check_admin_access($staff_id);
    ...
    public function add_salary()
    {
        ...
        if($statement_letter_info['promotion_flag'])
        {
            ...
            $promotion_pdf_return_data = $action_controller->promotion_progression_v2($promotion_pdf_info);
