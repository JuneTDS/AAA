...
class Summary_model extends CI_Model
{
    ...
    public function get_updated_or_completed_list($employee_data = null, $user_id = null)
    {
        ...
        if ($employee_data == null) {
            ...
            $employee_list = $this->db->query("SELECT CONCAT(u.first_name , ' ' , u.last_name) AS name, e.id AS emp_id, e.*, ue.user_id AS `user_id`, u.email AS `user_email`,payroll_offices.office_name, 
    ...
    public function get_job_remain_list($employee_data = null, $user_id = null)
    {
