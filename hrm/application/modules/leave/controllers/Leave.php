...
class Leave extends MX_Controller
{
    ...
    function __construct()
    {
        ...
        $this->employee_data      = $this->employee_model->get_staff_info($this->employee_id)[0];
        ...
        if(!$this->data['Admin']){
            ...
            {
                $this->remaining_al = $this->employee_data->remaining_annual_leave;
            }
            else
            {
    ...
    public function index()
    {
        ...
        {
            $this->data['employee_leave_list'] = $this->leave_model->get_employee_leaveList($this->employee_data);
            ...
            $this->data["leave_balance_list"] = $this->leave_model->get_leave_balance_list();
    ...
    public function transactions()
    {
        ...
        if (isset($_GET["fromdate"])) {
            $this->data['fromdate'] = $_GET["fromdate"];
        } else {
            $this->data['fromdate'] = "";
        }
        
        if (isset($_GET["todate"])) {
            $this->data['todate'] = $_GET["todate"];
        } else {
            $this->data['todate'] = "";
        }

        if (isset($_GET["employee"])) {
            $this->data['employee'] = $_GET["employee"];
        } else {
            $this->data['employee'] = "";
        }

        if (isset($_GET["leave-type"])) {
            $this->data['leave_type'] = $_GET["leave-type"];
        } else {
            $this->data['leave_type'] = "";
        }

        if(!$this->data['Admin'] && !$this->data['Manager']){
            $this->data['leave_list']   = $this->leave_model->get_employee_leaveList($this->employee_id, $this->data['fromdate'], $this->data['todate']);
            $this->data['dayoff_list']  = $this->leave_model->get_employee_dayoffList($this->employee_id, $this->data['fromdate'], $this->data['todate']);
        
            // $this->page_construct('index.php', $this->meta, $this->data);
            $this->page_construct('transactions.php', $meta, $this->data);
        }
        elseif($this->data['Manager'])
        {
            // $this->data['employee_leave_list'] = $this->leave_model->get_employee_leaveList($this->employee_data);
            $this->data['leave_list']       = $this->leave_model->get_employee_leaveList($this->employee_id, $this->data['fromdate'], $this->data['todate']); //this is for manager
            $this->data['dayoff_list']      = $this->leave_model->get_employee_dayoffList($this->employee_id, $this->data['fromdate'], $this->data['todate']);
            $this->data['employee_list']    = $this->leave_model->get_employeeList2();
            $this->data['leave_type_list']       = $this->leave_model->get_leave_type_list();
            // $this->data['action_list']  = $this->employment_json_model->get_action_result();
            // $this->data['history_list'] = $this->leave_model->get_history_leaveList2($this->user_id);
            // $this->data['calender_list'] = $this->leave_model->get_calender_leaveList2($this->user_id);
            // $this->data['holiday_list'] = $this->leave_model->get_calender_holidayList();
            ...
            // $this->page_construct('index_manager.php', $this->meta, $this->data);
            // $this->page_construct('transactions_manager.php', $meta, $this->data);
            $this->page_construct('transactions.php', $meta, $this->data);
        }else{
            $this->data['employee_list']    = $this->leave_model->get_employeeList2();
            $this->data['leave_list']       = $this->leave_model->get_leaveList($this->data); //this is for admin
            $this->data['dayoff_list']      = $this->leave_model->get_dayoffList($this->data);
            $this->data['leave_type_list']       = $this->leave_model->get_leave_type_list();
            // $this->data['action_list']       = $this->employment_json_model->get_action_result();
            // $this->data['history_list']      = $this->leave_model->get_history_leaveList();
            // $this->data['calender_list']     = $this->leave_model->get_calender_leaveList();
    ...
    public function amount()
    {
        ...
        $this->data['leave_list'] = $this->leave_model->get_leaves();
        $this->page_construct('leave_amount.php', $meta, $this->data);
    }
    ...
    public function editAmount()
    {
        ...
        $this->db->update('payroll_type_of_leave', $payroll_leave_data);
    ...
    public function calculate_working_days(){
        ...
        $holidays = $this->holiday_model->getAllHolidays($employee_id, $form_data['holiday_type']);     // get all defined holiday. New holiday can be added in block_holiday module.
