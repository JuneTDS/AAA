...
class Holiday_model extends CI_Model
{
    ...
    public function getAllHolidays($employee_id, $holidayType){
        ...
        $query = $this->db->query("SELECT * FROM payroll_block_holiday WHERE deleted = '0' AND (holiday_type = 3 || holiday_type = ".$holidayType.") AND offices_id = '".$office."' AND department_id = '".$department."' ");
        // return "SELECT * FROM payroll_block_holiday WHERE deleted = '0' AND (holiday_type = 3 || holiday_type = ".$holidayType.") AND offices_id = '".$office."' AND department_id = '".$department."' ";
