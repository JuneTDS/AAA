...
class Auth_model extends CI_Model
{
    ...
    public function register($username, $password, $email, $additional_data = array(),  $activation_code, $active = FALSE, $selected_firm = FALSE)
    {
    ...
    public function login($identity, $password, $remember = FALSE)
    {
        ...
        $query = $this->db->select($this->identity_column . ', username, email, id, password, active, last_login, last_ip_address, first_name, last_name, avatar, gender, group_id, date_of_expiry')
