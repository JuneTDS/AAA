	...
	<div class="panel-body">
		<div class="col-md-12">
			...
			<section class="panel">
				...
				<div class="panel-body">
					<input type="hidden" name="resend_flag" class="form-control" id="resend_flag" value="<?=isset($resend_flag)?$resend_flag:0?>"/>
					<input type="hidden" name="bank_auth_id" class="form-control" id="bank_auth_id" value=""/>
					<table class="table table-bordered table-striped table-condensed mb-none" style="width: 65%; display: inline-table;">
						<tr>
						...
						<tr>
							<th>Existing Auditor</th>
							<td>
								<div class="form-group input-group dropdown_audit_firm_name" style="width: 100%;">
						...
						<tr>
							<th>Our firm</th>
							<td>
								<div class="form-group input-group dropdown_our_firm" style="width: 100%;">
									<select id="our_firm_name" class="form-control our_firm_name" style="width: 100%;" name="our_firm_name">
						                    <option value="">Select Our Firm Name</option>
						            </select>
						        </div>
						        <div class="input_our_firm_name" style="width: 100%; display: none">
									<input type="text" id="text_our_firm_name" class="form-control text_our_firm_name" style="width: 100%;" name="text_our_firm_name">
						        </div>
							</td>
						</tr>
						<tr>
						...
						<tr id="date_tr">
							...
							<td>
								<div class="send_date_div">
									<div class="form-group">
										<div class="input-group" id="send_date" style="width: 30%;"><span class="input-group-addon"><i class="far fa-calendar-alt"></i></span><input type="text" class="send_date form-control" name="send_date" data-date-format="dd/mm/yyyy" data-plugin-datepicker required value="<?=isset($edit_first_letter[0]->send_date)?$edit_first_letter[0]->send_date:""?>">
											<!-- <?php $now = getDate();echo $now['mday'].'/'.$now['mon']."/".$now['year'];?> -->
										</div>
									</div>
								</div>
								...
								<div class="send_date_div">
									<div class="form-group">
										<div style="width: 70%;">
											...
											<textarea class="remark form-control" name="remark" rows="4"><?=isset($edit_first_letter)?$edit_first_letter[0]->remarks:""?></textarea>
										</div>
									</div>
								</div>
							</td>
					...
					<table class="table table-bordered" id="clearance_history_table" style="width: 32%;display: inline-table;float: right;">
						<caption><b>HISTORY</b></caption>
						<tr>

							<th class="text-center" style="width: 35%;">No</th>
							<th class="text-center" style="width: 65%">Timestamp</th>
						</tr>
						<tr class="tr_clearance_history">
							<td align="center" colspan="2"><p style="margin-top:10px;">No history to display</p></td>
						</tr>
					</table>
					<br/>
