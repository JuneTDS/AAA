						...
						<div class="panel-body">
							...
							<div class="tab-content">
								...
								<div id="programme_content" class="tab-pane">
									<form id="audit_question_form">
				                        <a class="amber" id="add_question_line" href="javascript:void(0);" onclick=add_question_line(this) data-toggle="tooltip" data-trigger="hover" style="font-weight:bold;float:right;" data-original-title="Add question" >
	                                    	<i class="fa fa-plus-circle amber" style="font-size:16px;"></i> Add Line
	                                    </a>
										<table class="table table-stripped" style="display: table;width: 100%;" id="audit_question_table">

				                            <tbody id="question_line">

				                            	<?php
				                        			if(!isset($question_lines) || !$question_lines)
				                        			{

				                        		?>
						                            	<tr style="width:100%">
						                            		<input type="hidden" name="question_id[]" class="question_id">
						                            		<td class="borderless" style="vertical-align: middle;width:5%;">
										    					<a class="amber remove_question_line" href="javascript:void(0)" data-toggle="tooltip" data-trigger="hover" style="font-weight:bold;float: right;top:50px;display: none;" data-original-title="Remove this line"  onclick=remove_question_line(this) ><i class="fa fa-minus-circle amber" style="font-size:13px;"></i></a>
										    				</td>
										    				<td class="borderless index_td" style="width:5%;vertical-align: middle;">1. </td>
						                                    <td class="borderless text-left question_text" id="id_index" style="width:90%;vertical-align: middle;">
						                                    	<textarea class="form-control" name="question_text[]"  rows="1" style="width:95%;display: inline-block;">Edit text. </textarea>
							                                </td>
...
<script type="text/javascript">
	...
	var save_all_qa_programme_setting_url = "<?php echo site_url('setting/save_all_qa_programme_setting'); ?>";
...
<script src="<?= base_url()?>application/modules/setting/js/audit_programme_qa.js" charset="utf-8"></script>
