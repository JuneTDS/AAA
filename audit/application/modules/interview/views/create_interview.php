		                    ...
		                    <div class="col-md-12">
	                                ...
	                                <div style="width: 100%;">
	                                    ...
	                                    <div style="width: 65%;float:left;margin-bottom:5px;">
	                                        <div class="input-group" style="width: 20%;">
	                                        	<input type="text" class="form-control" id="interview_company_name" name="interview_company_name" value="<?=isset($interview_detail['firm'])?$interview_detail['firm']: '' ?>" style="width: 400px;"/>
	                                        </div>
	                                    </div>
	                                </div>
	                            </div> -->
		                    	...
		                    	<div class="form-group">
	                                <div style="width: 100%;">
	                                    ...
	                                    <div style="width: 65%;float:left;margin-bottom:5px;">
	                                        <div style="width: 20%;">
	                                        	<input type="text" class="form-control" id="applicant_name" name="applicant_name" value="<?=isset($interview_detail['applicant_name'])?$interview_detail['applicant_name']: '' ?>" style="width: 400px;"/>
	                                        </div>
	                                        <div class="input-group" style="width: 30%">
			                    	...
			                    	<div style="width: 100%;">
				                    	...
				                    	<div style="width: 30%;float: left;">
							                <div class="input-group date form_datetime col-md-5" data-date-format="dd MM yyyy - HH:ii p" data-link-field="dtp_input1">
							                    <input name="interview_datetime" class="form-control" size="16" type="text" value="<?=isset($interview_detail['interview_time'])?$interview_detail['interview_time']: '' ?>" style="width:250px;">
	                            ...
	                            <div class="form-group">
			                    	<div style="width: 100%;">
				                    	...
				                    	<div style="width: 30%;float: left;">
							                <div class="input-group date form_datetime col-md-5" data-date-format="dd MM yyyy - HH:ii p" data-link-field="dtp_input1">
							                    <input name="interview_valid_datetime" class="form-control" size="16" type="text" value="<?=isset($interview_detail['interview_num_valid_until'])?$interview_detail['interview_num_valid_until']: '' ?>" style="width:250px;">
							                    <span class="input-group-addon"><span class="glyphicon glyphicon-remove"></span></span>
												<span class="input-group-addon"><span class="glyphicon glyphicon-th"></span></span>
							                </div>
							                <div class="input-group" style="width: 80%">
