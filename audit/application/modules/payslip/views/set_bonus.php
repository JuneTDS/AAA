				    ...
				    <div class="row">
				        <div class="col-lg-12">
				            <form id="set_bonus" method="POST">
				            	<input type="hidden" name="selected_month" value="<?=isset($selected_month)?$selected_month:''?>">
			                    <table class="table">
								  	<thead>
								    	<tr>
								      		<th scope="col">Employee Name</th>
								      		<th scope="col">AWS Awarded</th>
								      		<th scope="col">Bonus</th>
								      		<th scope="col">Commission</th>
								      		<th scope="col">Health Incentive</th>
								      		<th scope="col">Other Incentive</th>
								      		<th scope="col">
								...
								<div class="form-group row">
									<div class="col-sm-7">
								    	<?php echo '<a href="'.base_url().'payslip/index_admin" class="btn pull-right btn_cancel" style="margin:0.5%; cursor: pointer;">Cancel</a>';
								    		...
								    		{
								    			echo '<button class="btn btn_blue pull-right" style="margin:0.5%">Submit</button>';
								    		}
								    		else
								    		{
...
<script type="text/javascript">
	...
	function add_bonus_tr(obj){
		...
		$.ajax({
		  	...
		  	data: { 'count': count_bonus, 'bonus_details': obj },
		  	async:false,
