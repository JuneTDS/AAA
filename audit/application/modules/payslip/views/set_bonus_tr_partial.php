<tr class="bonus_tr">
    ...
    <td>
    	<?php
			echo form_dropdown('payslip_employee_name['.$count.']', $employee_name, isset($bonus_details['employee_id'])?$bonus_details['employee_id']:'', 'class="nationality-select" style="width:100%;"');
		?>
    </td>
    <td>
        <input type="checkbox" class="payslip_employee_aws" name=<?php echo 'payslip_employee_aws['.$count.']' ?> />
        <input type="hidden" class="hidden_payslip_employee_aws" name=<?php echo 'hidden_payslip_employee_aws['.$count.']'?> value=<?php echo isset($bonus_details['aws'])?($bonus_details['aws']>0?1:0):0 ?> />
    </td>
    <td>
    ...
    <td>
        <input type="checkbox" class="payslip_employee_health_incentive" name=<?php echo 'payslip_employee_health_incentive['.$count.']' ?> />
        <input type="hidden" class="hidden_payslip_employee_health_incentive" name=<?php echo 'hidden_payslip_employee_health_incentive['.$count.']'?> value=<?php echo isset($bonus_details['health_incentive'])?($bonus_details['health_incentive']>0?1:0):0 ?> />
    </td>
    <td>
        <input class="form-control" type="number" name=<?php echo 'payslip_employee_other_incentive['.$count.']' ?> value=<?php echo isset($bonus_details['other_incentive'])?$bonus_details['other_incentive']:'0.00' ?> />
    </td>
    <td>
