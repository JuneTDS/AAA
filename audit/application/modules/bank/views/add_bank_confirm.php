...
<section role="main" class="content_section" style="margin-left:0;">
	...
	<div class="panel-body">
		<div class="col-md-12">
			...
			<section class="panel">
				<form id="create_bank_confirm_form">
				<div class="panel-body">
					<input type="hidden" name="bank_confirm_id" class="form-control" id="bank_confirm_id" value=""/>
					<table class="table table-bordered table-striped table-condensed mb-none">
						...
						<tr>
							...
							<td>
								<div class="form-group fye_date_div">
								<div class="input-group" id="fye_date" style="width: 30%;"><span class="input-group-addon"><i class="far fa-calendar-alt"></i></span><input type="text" class="fye_date form-control" name="fye_date" data-date-format="dd/mm/yyyy" data-plugin-datepicker required value="">
	...
	<!-- 					<tr>
							...
							<td>
								<div class="input-group" style="width: 30%;">
									<select id="confirm_status" class="form-control confirm_status" style="width: 100%;" name="confirm_status">
				...
				<footer class="panel-footer">
					<div class="row">
						<div class="col-md-12 number text-right">
							...
							<button type="submit" class="btn btn-primary" name="saveConfirm" id="saveConfirm">Save & Generate</button>
...
<script type="text/javascript">
	...
	var save_bank_confirm_url = "<?php echo site_url('bank/save_bank_confirm'); ?>";
	var generate_confirm_document_url = "<?php echo site_url('bank/generate_confirm_document'); ?>";
	var bank_url = "<?= base_url();?>bank?tab_active=bank_list";
	var bank_url_redirect = "<?= base_url();?>bank";
...
<script src="<?= base_url()?>application/modules/bank/js/add_bank_confirm.js" charset="utf-8"></script>