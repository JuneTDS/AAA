...
<section role="main" class="content_section" style="margin-left:0;">
	<section class="panel" style="margin-top: 0px;">
		<form id="form_state_cash_flows">
			...
			<table class="table table-hover table-borderless" style="margin: 2%; width: 95%; border-collapse: collapse; color:black;" border="0">
				<thead>
					<tr>
						...
						<?php
							if($is_group)
							{
								echo '<th style="width: 25%; text-align: center; border-bottom:1px solid black;" colspan="' . $colspan_val . '">Group</th>';
								echo '<th style="width: 1%;">&nbsp;</th>';
							}

							echo '<th style="width: 25%; text-align: center; border-bottom:1px solid black;" colspan="' . $colspan_val . '">Company</th>';
						?>
					</tr>
					<tr>
						<?php
		...
		if(is_group){
			...
			if(last_fye_end !== '')
			{
				template = '<tr class="'+ tr_class +'">' + 
							...
							'</td>'+
							'<td style="width: 1%;">&nbsp;</td>'+
							'<td class="company_ye" style="width: 12.5%; text-align:right;">' + negative_bracket_js(value_company_ye) + '</td>'+
							'<td class="company_lye" style="width: 12.5%; text-align:right;">' + 
		...
		if(is_group){
			...
			if(last_fye_end !== '')
			{
				template = '<tr class="'+ tr_class +'">' + 
							...
							'</td>'+
							'<td style="width: 1%;">&nbsp;</td>'+
							'<td class="company_ye" style="width: 12.5%; text-align:right;">' + negative_bracket_js(0) + '</td>'+
							'<td class="company_lye" style="width: 12.5%; text-align:right;">' + 
