		...
		<div class="col-md-12">
			<div class="row datatables-header form-inline">
				...
				<div id="buttonclick" style="display:block;padding-top:10px;table-layout: fixed;width:100%">
					<table class="table" id="datatable_history" style="width:100%">
						<thead>
								...
								foreach($reimbursement_list as $row)
					  			{
					  				...
					  				echo '<td><a href="reimbursement/history_content/'. $row->employee_id . '/' . $row->client_name . '/' . $row->firm_name . '" style="cursor:pointer;">view</a></td>';
  		...
  		if(selected_length > 0){
	        if(isApprove){
	        	...
	        	if(confirm("Confirm to REJECT the selected claim?")){
	        		$.each($("input[name='select_claim']:checked"), function(){  
	        			var reimbursement_id = $(this).parent().parent().find('.reimbursement_id');       
