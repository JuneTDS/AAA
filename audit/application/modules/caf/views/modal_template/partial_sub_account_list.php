...
<div id="partial_sub_account_list">
  ...
  <div id="psal_sub_account_list" class="form-group" style="height: 300px; overflow-y: auto; display: none;">
    ...
    <div class="form-group">
      <div class="col-xs-12">
        <input id="search_sub_acc" class="form-control search_input_width" aria-controls="datatable-default" placeholder="Search" type="search" style="float:right;" onkeyup="filter_sub_account()">
      </div>
    </div>
    <div class="form-group">
      <div class="col-xs-12">
