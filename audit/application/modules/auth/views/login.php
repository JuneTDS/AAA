...
<body class="login-page" style="background: url('../assets/background/login_background4.jpg'); background-size: cover;
            ...
            <div class="panel-body" style="background-color: white; border-radius: 10px;" >
                ...
                <?php if ($error) { ?>
                    ...
                    <div class="form-action clearfix" style="margin-bottom: 20px;margin-top: -20px !important;">
                        ...
                        <button type="submit" class="btn btn_blue btn-lg pull-right"><?= lang('login') ?> &nbsp; 
            ...
            <div class="panel-body" style="background-color: white; border-radius: 10px;" >
                <div class="text-center">
                    ...
                    <div class="form-action clearfix">
                        <a class="btn btn-lg btn_blue pull-left login_link" href="#login"><i
                                class="fa fa-chevron-left"></i> <?= lang('back') ?>  </a>
                        <button type="submit" class="btn btn_blue btn-lg pull-right"><?= lang('submit') ?> &nbsp;&nbsp; 
                            <i class="fa fa-envelope"></i>
                        </button>
                    </div>
                    <?php echo form_close(); ?>
                ...
                <div class="text-center">
                    ...
                    <?php } ?>
                        ...
                        <div class="form-group row">
                            ...
                            <span style="color:#154069;display: block;font-size: 12px;margin-top: 5px;"><?= lang('pasword_hint') ?></span>
                        </div>
                    ...
                    <div class="form-action clearfix">
                        <a class="btn btn-lg btn_blue pull-left login_link" href="#login"><i
                                class="fa fa-chevron-left"></i> <?= lang('back') ?>  </a>
                        <button type="submit" class="btn btn_blue btn-lg pull-right"><?= lang('register') ?> &nbsp;&nbsp; 
                            <i class="fa fa-user"></i>
                        </button>
                    </div>
                    <?php echo form_close(); ?>
            ...
            <div class="panel-body" style="background-color: white; border-radius: 10px;" >
                <div class="text-center">
                    ...
                    <div class="form-action clearfix" style="margin-bottom: 20px;margin-top: 20px !important;">
                        ...
                        <a href="login" class="btn btn_blue pull-right">OK</a>
                    </div>
                </div>
            </div>
            </div>
        ...
        <section class="body-sign">
            ...
            <div class="panel-body" style="background-color: white; border-radius: 10px;" >
                <div class="text-center">
                    ...
                    <?php } ?>
                    <div class="form-action clearfix" style="margin-bottom: 20px;margin-top: 20px !important;">
                        <a href="<?= base_url('auth/login');?>" class="btn btn_blue pull-right">OK</a>
                    </div>
                </div>
            </div>
