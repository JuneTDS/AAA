    ...
    <section class="panel" style="margin-top: 30px;">
        <div class="panel-body" style="background-color: white; border-radius: 10px;" >  
                ...
                <div class="form-group">
                    <div class="controls">
                        ...
                        <div class="col-sm-5">
                            ...
                            <span style="color:#154069;display: block;font-size: 12px;margin-top: 5px;">At least 1 capital, 1 lowercase, 1 number and more than 8 characters long</span>
                        </div>
            ...
            <div class="col-md-12 text-right" style="margin-top: 10px;">
                <input type="submit" name="add_user" value="Add User" class="btn btn_blue create_user_submit" id="create_user_submit">
