...
<link href="<?= base_url() ?>application/css/bootstrap-multiselect/bootstrap-switch.min.css" media="all" rel="stylesheet" type="text/css"/>
                                ...
                                <div class="modal-wrapper">
                                    <div class="modal-text">
                                                    ...
                                                    <div class="box-content">
                                                        <div class="row">
                                                            <div class="col-lg-12">
                                                                ...
                                                                <input type="hidden" class="form-control" id="firm_id" name="firm_id" value="<?= isset($firm[0]->id)?$firm[0]->id:''?>"/>
                                                                        ...
                                                                        <div class="col-md-12">
                                                                            ...
                                                                            <div class="form-group">
                                                                                <div style="width: 100%;">
                                                                                    ...
                                                                                    <div style="width: 65%;float:left;margin-bottom:5px;">
                                                                                        ...
                                                                                        <input type="text" class="form-control" id="registration_no" name="registration_no" value="<?= isset($firm[0]->registration_no)?$firm[0]->registration_no:'' ?>" style="width: 400px;"/>
                                                                            ...
                                                                            <div class="form-group">
                                                                                <div style="width: 100%;">
                                                                                    ...
                                                                                    <div style="width: 65%;float:left;margin-bottom:5px;">
                                                                                        <div class="input-group" style="width: 20%;" >
                                                                                        <input type="text" class="form-control" id="name" name="name" value="<?= isset($firm[0]->name)?$firm[0]->name:'' ?>" style="width: 400px;"/>
                                                                            ...
                                                                            <div class="form-group">
                                                                                <div style="width: 100%;">
                                                                                    ...
                                                                                    <div style="width: 65%;float:left;margin-bottom:5px;">
                                                                                        ...
                                                                                        <div class="input-group fieldGroup_telephone">
                                                                                            <input type="tel" class="form-control check_empty_telephone main_telephone hp" id="telephone" name="telephone[]" value="<?= isset($client_contact_info[0]->telephone)?$client_contact_info[0]->telephone : ""; ?>"/>
                                                                                ...
                                                                                <div style="width: 100%;">
                                                                                    ...
                                                                                    <div style="width: 65%;float:left;margin-bottom:5px;">
                                                                                        ...
                                                                                        <div class="input-group fieldGroup_fax">
                                                                                            <input type="tel" class="form-control check_empty_fax main_fax hp" id="fax" name="fax[]" value="<?= isset($client_contact_info[0]->fax) ? $client_contact_info[0]->fax : ""; ?>"/>
                                                                                            ...
                                                                                            <!-- <span class="input-group-btn" style="vertical-align: top !important;"> -->
                                                                                                <input class="btn btn_purple button_increment_fax addMore_fax" type="button" id="create_button" value="+" style="margin-left: 20px; margin-top: -26px; border-radius: 3px;visibility: hidden; width: 35px;"/>
                                                                                            <!-- </span> -->
                                                                                        ...
                                                                                        <div class="input-group fieldGroupCopy_fax fax_disabled" style="display: none;">
                                                                                            ...
                                                                                            <!-- <span class="input-group-btn" style="vertical-align: top !important;"> -->
                                                                                                <input class="btn btn_purple button_decrease_fax remove_fax" type="button" id="create_button" value="-" style="margin-left: 20px; margin-top: -26px; border-radius: 3px; width: 35px;"/>
                                                                                            <!-- </span> -->
                                                                                        </div>
                                                                                ...
                                                                                <div style="width: 100%;">
                                                                                    ...
                                                                                    <div style="width: 65%;float:left;margin-bottom:5px;">
                                                                                        ...
                                                                                        <div class="input-group fieldGroup_email" style="display: block !important;">
                                                                                            <input type="text" class="form-control input-xs check_empty_email main_email" id="email" name="email[]" value="<?= isset($client_contact_info[0]->email) ? $client_contact_info[0]->email : ""; ?>" style="width:400px;"/>
                                                                                            ...
                                                                                            <!-- <span class="input-group-btn" style="vertical-align: top !important;"> -->
                                                                                                <input class="btn btn_purple button_increment_email addMore_email" type="button" id="create_button" value="+" style="margin-left: 10px; border-radius: 3px;visibility: hidden; width: 35px;"/>
                                                                                            <!-- </span> -->
                                                                                        ...
                                                                                        <div class="input-group fieldGroupCopy_email email_disabled" style="display: none;">
                                                                                            ...
                                                                                            <!-- <span class="input-group-btn" style="vertical-align: top !important;"> -->
                                                                                                <input class="btn btn_purple button_decrease_email remove_email" type="button" id="create_button" value="-" style="margin-left: 10px; border-radius: 3px; width: 35px;"/>
                                                                                            <!-- </span> -->
                                                                                        </div>
                                                                            ...
                                                                            <div class="form-group">
                                                                                <div style="width: 100%;">
                                                                                    ...
                                                                                    <div style="width: 65%;float:left;margin-bottom:5px;">
                                                                                        <div class="input-group" style="width: 20%;" >
                                                                                            <input type="text" class="form-control" id="url" name="url" value="<?= isset($firm[0]->url)?$firm[0]->url:'' ?>" style="width: 400px;"/>
                                                                            ...
                                                                            <div class="form-group">
                                                                                ...
                                                                                <div style="width: 65%;float:left;margin-bottom:5px;">
                                                                                    ...
                                                                                    <div style="width: 100%;">
                                                                                        <label><input type="radio" id="local_edit" name="address_type" <?php print isset($firm[0]->local_status)?$firm[0]->local_status:''; ?> value="Local"/>&nbsp;&nbsp;Singapore Address</label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<label><input type="radio" id="foreign_edit" name="address_type" <?php print isset($firm[0]->foreign_status)?$firm[0]->foreign_status:''; ?> value="Foreign"/>&nbsp;&nbsp;Malaysia Address</label>
                                                                                    </div>
                                                                                    ...
                                                                                    <div style="margin-bottom:5px;">
                                                                                            ...
                                                                                            <div style="width: 65%;float:left;margin-bottom:5px;">
                                                                                                <div class="input-group" style="width: 20%;" >
                                                                                                    <input type="text" class="form-control" id="postal_code" name="postal_code" value="<?= isset($firm[0]->postal_code)?$firm[0]->postal_code:'' ?>" maxlength="6">
                                                                                                </div>
                                                                                        ...
                                                                                        <div style="margin-bottom:5px;">
                                                                                            ...
                                                                                            <div style="width: 71%;float:left;margin-bottom:5px;">
                                                                                                <div class="input-group" style="width: 100%;" >
                                                                                                    <input type="text" class="form-control" id="street_name" name="street_name" value="<?= isset($firm[0]->street_name)?$firm[0]->street_name:'' ?>">
                                                                                                </div>
                                                                                        ...
                                                                                        <div style="margin-bottom:5px;">
                                                                                            ...
                                                                                            <div class="input-group" style="width: 71%;" >
                                                                                                <input style="width: 100%;" type="text" class="form-control" id="building_name" name="building_name" value="<?= isset($firm[0]->building_name)?$firm[0]->building_name:'' ?>">
                                                                                        ...
                                                                                        <div style="margin-bottom:2px;">
                                                                                            ...
                                                                                            <div class="input-group" style="width: 10%;display: inline-block">
                                                                                                        <input style="width: 100%; margin-right: 10px;" maxlength="3" type="text" class="form-control" id="unit_no1" name="unit_no1" value="<?= isset($firm[0]->unit_no1)?$firm[0]->unit_no1:'' ?>">
                                                                                                        <?php echo form_error('unit_no1','<span class="help-block">*','</span>'); ?>
                                                                                                    </div>
                                                                                                    <div class="input-group" style="width: 20%;display: inline-block" >
                                                                                                        <input style="width: 100%;" maxlength="10" type="text" class="form-control" id="unit_no2" name="unit_no2" value="<?= isset($firm[0]->unit_no2)?$firm[0]->unit_no2:'' ?>">
                                        ...
                                        <div style="width: 100%;">
                                            <div style="width: 95%;float:left;margin-bottom:5px;">
                                                <div class="add-input-group" style="width: 95%;" >
                                                    <input style="margin-bottom: 5px;" type="text" class="form-control input-xs" id="foreign_address1" name="foreign_address1" value="<?= isset($firm[0]->foreign_address1)?$firm[0]->foreign_address1:'' ?>"> 
                                                </div>
                                        ...
                                        <div style="width: 100%;">
                                            <div style="width: 95%;float:left;margin-bottom:5px;">
                                                <div class="add-input-group" style="width: 95%;" >
                                                    <input style="margin-bottom: 5px;" type="text" class="form-control input-xs" id="foreign_address2" name="foreign_address2" value="<?= isset($firm[0]->foreign_address2)?$firm[0]->foreign_address2:'' ?>">
                                        ...
                                        <div style="width: 100%;">
                                            <div style="width: 95%;float:left;margin-bottom:5px;">
                                                <div class="add-input-group" style="width: 95%;" >
                                                    <input type="text" class="form-control input-xs" id="foreign_address3" name="foreign_address3" value="<?= isset($firm[0]->foreign_address3)?$firm[0]->foreign_address3:'' ?>">
                                ...
                                <input type="hidden" name="gst_checkbox" value=""/>
                                    <!-- <div class="completed_report_date" style="width: 50%;">
                                        <div class="input-group date datepicker" data-provide="datepicker">
                                            ...
                                            <input type="text" class="billing_date form-control" id="no_gst_date" name="no_gst_date" data-date-format="dd/mm/yyyy" data-plugin-datepicker value="<?=isset($firm[0]->no_gst_date)?$firm[0]->no_gst_date:'' ?>" disabled>
                                        </div>
                                    </div> -->
                                            
                                            <div style="float: right;display: none;" id="div_no_gst">
                                                <label style="margin-left: 105px;margin-right: 37px;">Since :</label>
                                                <div class="input-group date datepicker" data-provide="datepicker" id="billing_date" style="width:227px;float: right;">
                                                    <span class="input-group-addon">
                                                        <i class="far fa-calendar-alt"></i>
                                                    </span>
                                                    <input type="text" class="billing_date form-control" id="no_gst_date" name="no_gst_date" data-date-format="dd/mm/yyyy" data-plugin-datepicker value="<?=isset($firm[0]->no_gst_date)?$firm[0]->no_gst_date:'' ?>" disabled>
                                                                                        ...
                                                                                        <div>
                                                                                            <label style="width: 15%;float:left;margin-right: 2px;">
                                                                                                <input style="margin-right: 10px;" type="text" class="form-control" id="gst_value" name="gst_value" value="<?= isset($firm[0]->gst)?$firm[0]->gst:'' ?>" maxlength="5">
                                                                                            ...
                                                                                            <div style="width: 30%;float: left;" id="">
                                                                                                <div  class="input-group date datepicker" data-provide="datepicker" id="billing_date">
                                                                                                    <span class="input-group-addon">
                                                                                                        <i class="far fa-calendar-alt"></i>
                                                                                                    </span>
                                                                                                    <input type="text" class="billing_date form-control" id="gst_date" name="gst_date" data-date-format="dd/mm/yyyy" data-plugin-datepicker value="<?= isset($firm[0]->gst_date)?$firm[0]->gst_date:'' ?>">
                                                                                                </div>
                                                                                        ...
                                                                                        <div id="previous_gst_info" style="display: none;">
                                                                                            <label style="width: 15%;float:left;margin-right: 2px;"><input style="margin-right: 10px;" type="text" class="form-control" id="previous_gst_value" name="previous_gst_value" value="<?= isset($firm[0]->previous_gst)?$firm[0]->previous_gst:'' ?>" disabled></label>
                                                                                            <div style="width: 5%; float: left;margin-right: 20px;">%</div>
                                                                                            <div style="width: 10%; float: left;">Since :</div>
                                                                                            ...
                                                                                            <div style="width: 30%;float: left;" id="">
                                                                                                <div  class="input-group date datepicker" data-provide="datepicker" id="billing_date">
                                                                                                    ...
                                                                                                    <input type="text" class="billing_date form-control" name="previous_gst_date" data-date-format="dd/mm/yyyy" data-plugin-datepicker value="<?= isset($firm[0]->previous_gst_date)?$firm[0]->previous_gst_date:'' ?>" disabled>
                                                                                                </div>
                                                                                            </div>
                                                                ...
                                                                <div class="col-md-12 text-right" style="margin-top: 10px;">
                                                                    <?php echo form_submit(base_url() . 'save_firm', 'Save', 'class="btn btn_purple"'); ?>
                                                                    <a href="<?= base_url();?>firm/" class="btn btn-default">Cancel</a>
                                                                </div>
                                                                <?php echo form_close(); ?>
                                                            </div>
                                                        </div>
                                                ...
                                                <table class="table table-bordered table-striped table-condensed mb-none" id="bank_info_table">
                                                    <thead>
                                                        <div class="tr">
                                                            ...
                                                            <a href="javascript: void(0);" class="th" rowspan=2 style="color: #9349BD;width:170px; outline: none !important;text-decoration: none;"><span id="bank_Add" data-toggle="tooltip" data-trigger="hover" data-original-title="Create Bank Info" style="font-size:14px;"><i class="fa fa-plus-circle"></i> Add Bank</span></a>
...
// var company_code = <?php //echo json_encode(isset($company_code)?$company_code:null);?>;
var edit_firm_telephone = <?php echo json_encode(isset($firm[0]->firm_telephone)?$firm[0]->firm_telephone:null);?>;
var edit_firm_fax = <?php echo json_encode(isset($firm[0]->firm_fax)?$firm[0]->firm_fax:null);?>;
var edit_firm_email = <?php echo json_encode(isset($firm[0]->firm_email)?$firm[0]->firm_email:null);?>;
var initialPreviewArray = []; 
var initialPreviewConfigArray = [];
var base_url = '<?php echo base_url() ?>';
var domain = window.location.origin;
var files = <?php echo json_encode(isset($firm[0]->file_name)?$firm[0]->file_name:null);?>;
var bank_info = <?php echo json_encode(isset($bank_info)?$bank_info:null);?>;
var firm_id = <?php echo json_encode(isset($firm_id)?$firm_id:null);?>;
var tab = <?php echo json_encode(isset($tab)?$tab:null);?>;
</script>
...
<script src="<?= base_url() ?>application/js/bank_info.js"></script>
...
$("#registration_no").on('change',function(){
...
$("#no_gst_date").on('change',function(){
    $(this).parent().parent().parent().find("DIV#form_no_gst_date").html( "" );
});

$("#gst_date").on('change',function(){
...
$("#foreign_address1").on('change',function(){
...
function preview_image(files)
{
    if(files != null)
    {
        /*for (var i = 0; i < files.length; i++) {*/
          ...
          var url = domain + "/secretary/uploads/logo/";
          ...
          //console.log(file_type);
            /*if(file_type == ".pdf")
            {
              initialPreviewConfigArray.push({
                  type: "pdf",
                  caption: fileArray[1],
                  url: "/dot/firm/deleteFile/" + fileArray[0],
                  width: "120px",
                  key: i+1
              });
            }
...
$("#logo").fileinput({
    theme: 'fa',
    uploadUrl: '/audit/firm/uploadFile', // you must set a valid URL here else you will get an error
    uploadAsync: false,
    ...
    initialPreviewDownloadUrl: domain + '/secretary/uploads/logo/{filename}',
    ...
    $("#loadingmessage").hide();
    // window.location.href = base_url + "firm";
