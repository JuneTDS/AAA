...
<section class="panel" style="margin-top: 30px;">
	<header class="panel-heading">
		<div class="panel-actions">
			<!-- <a class="create_client themeColor_blue" href="mc_claim/apply_mc" data-toggle="tooltip" data-trigger="hover" style="height:45px;font-weight:bold;" data-original-title="Create Interview" ><i class="fa fa-plus-circle themeColor_blue" style="font-size:16px;height:45px;"></i> Apply MC</a> -->
		</div>
		<h2></h2>
	</header>
								...
								foreach($mc_list as $row)
					  			{
					  				...
					  				echo '<td align="center">
					  						<button class="btn btn_blue" style="margin:0.5%" onclick="change_mc_status(this, true)">Approve</button>
					  				...
					  				// 	}else{
					  				// 		echo '<td align="center"><a href="mc_claim/claim_apply/'. $row->mc_id .'" class="btn btn_blue">Apply</a></td>';
					  				// 	}
					  				// }else{
								...
								foreach($claim_list as $row)
					  			{
					  				...
					  				echo '<td>'.$row->claim_status.'</td>';
					  				echo '<td align="center">
					  						<button class="btn btn_blue" style="margin:0.5%" onclick="change_claim_status(this, true)">Approve</button>
