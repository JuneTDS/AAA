		...
		<div class="col-md-12">
			...
			<div id="w2-engagement_letter" class="panel">
				<form id="engagement_letter_form" style="margin-top: 20px;">
					...
					<input type="hidden" class="form-control el_id" id="el_id" name="el_id" value=""/>
					...
					<div class="form-group">
						...
						<div class="col-sm-8">
							<div class="input-group" style="width: 200px;">
								...
								<input autocomplete="off" type="text" class="form-control valid engagement_letter_date" name="engagement_letter_date" data-date-format="dd/mm/yyyy" data-plugin-datepicker="" required="" value="" placeholder="DD/MM/YYYY">
							</div>
						</div>
					</div>
...
<script type="text/javascript">
	...
	var get_engagement_letter_detail_url = "<?php echo site_url('engagement/get_engagement_letter_detail'); ?>";
	...
	var save_engagement_letter_url = "<?php echo site_url('engagement/save_engagement_letter'); ?>";
...
<script src="<?= base_url()?>application/modules/engagement/js/add_engagement_letter.js" charset="utf-8"></script>