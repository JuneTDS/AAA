...
$(document).on('click',"#bank_Add",function() {
	...
	$a += '</div>';
	$a += '<div class="td bank_action"><div style="display: inline-block; margin-right: 5px; margin-bottom: 5px;"><button type="button" class="btn btn_blue submit_bank_info_button" onclick="edit_bank(this);">Save</button></div><div style="display: inline-block;"><button type="button" class="btn btn_blue" onclick="delete_bank_info(this);">Delete</button></div></div>';
...
{console.log(bank_info);
	for(var i = 0; i < bank_info.length; i++)
	{
		...
		$a += '</div>';
		$a += '<div class="td bank_action"><div style="display: inline-block; margin-right: 5px; margin-bottom: 5px;"><button type="button" class="btn btn_blue submit_bank_info_button" onclick="edit_bank(this);">Edit</button></div><div style="display: inline-block;"><button type="button" class="btn btn_blue" onclick="delete_bank_info(this);">Delete</button></div></div>';
