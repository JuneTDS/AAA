             ...
             <div class="center-sign">
                <div class="panel panel-sign">
                    <ul class="nav nav-tabs nav-justify login_nav" id="myTab">
                        <li class="active check_stat" id="li-passwordLogin" data-information="passwordLogin" style="width: 100%;">
                            <a href="#nav-passwordLogin" data-toggle="tab" class="text-center header_login" style="width: 100% !important;">
                                Password Login
                            </a>
                        </li>
