                ...
                <div class="modal-text">
                    <div class="tabs">
                        ...
                        <ul class="nav nav-tabs nav-justify" id="myTab">
                            ...
                            <!-- <li class="users_check_state" id="li-userPasswordList" data-information="userPasswordList">
                                <a href="#w2-userPasswordList" data-toggle="tab" class="text-center ">
                                    <span class="badge hidden-xs">2</span>
                                    User Password
                                </a>
                            </li> -->
                        ...
                        <div class="tab-content">
                            <div id="w2-userList" class="tab-pane active">
                                <header class="panel-heading" style="padding: 28px;display: none;">
                                    ...
                                    ?>
                                        <div class="col-md-12">
                                            ...
                                            <div class="col-md-4 search_group_button">
                                                ...
                                                <button class="reset-all btn btn-primary" type="button" onClick="resetPassword()">Reset Password (All)</button>
                                            </div>
                                                            ...
                                                            <?php
                                                                ...
                                                                if(isset($user))
                                                                {
                                                                    foreach($user as $p)
                                                                    {
                                                                        ...
                                                                        <button type="button" class="btn btn-primary reset" onclick="resetPassword('.$p->id.')">Reset Password</button>
                                                                        </td>';
                                                                        echo '</tr>';
                            ...
                            <!-- <div id="w2-userPasswordList" class="tab-pane">
                                <div>
                                    <div style="margin-bottom: 10px">
                                        <div class="col-md-8">
                                            <input type="text" class="form-control billing_search" id="w2-username" name="search" placeholder="Search Employee" value="<?=isset($_POST['search'])?$_POST['search']:'';?>">
                                        </div>
                                        <div>
                                            <button class="reset-all btn btn-primary" type="button" onClick="resetPassword()">Reset Password (All)</button>
                                        </div>
                                    ...
                                    <div>
                                        <table class="table table-bordered table-striped table-condensed mb-none" id="userPasswordList_info_table">
                                            <thead>
                                                <tr>
                                                    <th>First Name</th>
                                                    <th>Last Name</th>
                                            ...
                                            <tbody>
                                                ...
                                                //         echo '<tr>';
                                                //         echo '<td style="word-break:break-all;">';
                                                //         echo "".ucwords(substr($p->first_name,0,23))."<span id='h".$i."' style='display:none;cursor:pointer'>".substr($p->first_name,23,strlen($p->first_name))."</span>";
                                                ...
                                                //         echo '<td><button type="button" class="btn btn-primary reset" onclick="resetPassword('.$p->id.')">Reset Password</button></td>';
                                                //         echo '</tr>';
...
<style>
    ...
    #userPasswordList_info_table_wrapper>div.row:first-child {
        display:none;
    }
</style>
...
<script type="text/javascript">
    ...
    function resetPassword(userID = null) {
        $('#loadingmessage').show();
        $.ajax({ //Upload common input
            url: "auth/reset_password_by_admin",
            type: "POST",
            data: {"user_id": userID},
            dataType: 'json',
            success: function (response) {
    ...
    $('#userPasswordList_info_table').dataTable();
