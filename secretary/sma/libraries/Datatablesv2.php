  ...
  class Datatablesv2
  {
    ...
    */
    private function produce_output($output, $charset)
    {
      ...
      {
        $aaData[$row_key] =  ($this->check_cType())? $row_val : $row_val;
    ...
    */
    private function get_total_results($filtering = FALSE)
    {
      ...
      $subquery = str_replace("SELECT *", "SELECT ".array_values($this->select)[0]." ", $subquery);
      ...
      // $subquery = $this->ci->db->get($this->table)->num_rows();
      // return $subquery;
    }
